...
st.markdown("""
    <style>
    body { background: linear-gradient(135deg, #141E30, #243B55); color: white; font-family: 'Poppins', sans-serif; }
    .title { font-size: 42px; font-weight: 800; text-align: center; color: #FFD700; margin-bottom: 15px; }
    .movie-card {
    ...
    .movie-title { font-size: 22px; font-weight: 700; color: #00FFCC; }
    .movie-rating { color: #FFD700; font-weight: 600; }
    </style>
""", unsafe_allow_html=True)

# ✅ All lists same length (56 movies)
titles = [
    "Inception", "Titanic", "Avengers: Endgame", "The Dark Knight", "La La Land", "The Conjuring", "Interstellar",
    "Frozen", "Parasite", "Dune", "Gladiator", "Avatar", "The Notebook", "Joker", "Toy Story", "Finding Nemo",
    "Doctor Strange", "Black Panther", "Up", "Inside Out", "Shutter Island", "Us", "The Matrix", "Coco",
    "The Lion King", "Pulp Fiction", "Fight Club", "Forrest Gump", "The Shawshank Redemption", "The Godfather",
    "Avengers: Infinity War", "Spider-Man: No Way Home", "The Batman", "Guardians of the Galaxy", "Iron Man",
    "Thor: Ragnarok", "Captain America: Civil War", "Ant-Man", "WALL-E", "Moana", "Zootopia", "Encanto",
    "Cinderella", "Mulan", "Beauty and the Beast", "The Nun", "Annabelle", "Hereditary", "IT", "The Exorcist",
    "Get Out", "Nope", "The Silence of the Lambs", "Seven", "Gone Girl", "Knives Out", "Tenet"
]

genres = [
    "Sci-Fi", "Romance", "Action", "Action", "Romance", "Horror", "Sci-Fi", "Animation", "Thriller", "Sci-Fi",
    "Action", "Sci-Fi", "Romance", "Drama", "Animation", "Animation", "Action", "Action", "Animation", "Animation",
    "Thriller", "Horror", "Sci-Fi", "Animation", "Animation", "Crime", "Drama", "Drama", "Drama", "Crime",
    "Action", "Action", "Action", "Action", "Action", "Action", "Action", "Action", "Animation", "Animation",
    "Animation", "Animation", "Animation", "Animation", "Horror", "Horror", "Horror", "Horror", "Horror", "Horror",
    "Horror", "Thriller", "Thriller", "Thriller", "Mystery", "Sci-Fi"
]

ratings = [
    8.8, 7.8, 8.4, 9.0, 8.0, 7.5, 8.6, 7.4, 8.6, 8.3, 8.5, 7.8, 7.9, 8.5, 8.3, 8.2, 7.5, 7.3, 8.2, 8.1, 8.1,
    6.9, 8.7, 8.4, 8.5, 8.9, 8.8, 8.8, 9.3, 9.2, 8.4, 8.3, 8.1, 8.0, 7.9, 7.8, 7.6, 7.5, 8.4, 8.1, 8.0, 7.9,
